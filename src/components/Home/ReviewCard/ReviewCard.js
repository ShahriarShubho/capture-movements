...
const ReviewCard = ({review}) => {
  ...
  return (
    <section className ="com-md-4">
          <div class="card text-center m-3 p-3" style={{ width: "16rem", height: "19rem"}}>
      <img src={images} style={{ width: "70px", margin : "auto", borderRadius : "40px"}} class="card-img-top" alt="Your email has no pictur"></img>
      <div class="card-body">
