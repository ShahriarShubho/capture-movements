  ...
  return (
    <footer className="row py-5 footerImg">
      ...
      <div className="col-md-4 text-center">
        ...
        <div>
        <FontAwesomeIcon  className ='icon' icon={faTwitter} /> <FontAwesomeIcon  className ='icon' icon={faFacebookF} /> <FontAwesomeIcon  className ='icon' icon={faInstagram} /> <FontAwesomeIcon  className ='icon' icon={faGooglePlusG} />
